...
//            print("请求到1组数据")
        ...
        // "http://capi.douyucdn.cn/api/v1/getHotCate?limit=4&offset=0&time=\(nowDate)"
        //?limit=4&offset=0&time=\(nowDate)"
        let urlString = "http://capi.douyucdn.cn/api/v1/getHotCate"
        dGroup.enter()
        loadAnchorData(isGroupData: true,URLString: urlString, parameters: parameters) {
            dGroup.leave()
        }
